...
DST_DIR='/Developer/Platforms/iPhoneOS.platform/Developer/Library/Xcode/Project Templates/Application/cocos2d-0.8.2 Application/'
...
DST_DIR='/Developer/Platforms/iPhoneOS.platform/Developer/Library/Xcode/Project Templates/Application/cocos2d-0.8.2 Box2d Application/'
LIBS_DIR="$DST_DIR"libs
...
DST_DIR='/Developer/Platforms/iPhoneOS.platform/Developer/Library/Xcode/Project Templates/Application/cocos2d-0.8.2 Chipmunk Application/'
LIBS_DIR="$DST_DIR"libs
