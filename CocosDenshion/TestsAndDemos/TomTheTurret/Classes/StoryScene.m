...
- (id) init {
    ...
    if ((self = [super init])) {
        ...
        self.label = [CCLabelTTF labelWithString:@"" dimensions:CGSizeMake(winSize.width - LABEL_MARGIN*2, winSize.height - LABEL_MARGIN-LABEL_MARGIN_BOTTOM) alignment:UITextAlignmentCenter vertAlignment:kCCVerticalTextAlignmentTop fontName:@"Verdana" fontSize:24];
