...
class SpiderMonkey(object):
    def __init__(self, bridgesupport_file, hierarchy_file, namespace, classes_to_bind=[] ):
...
def help():
    ...
    print "\nExample:"
    print "\t%s -b cocos2d-mac.bridgesupport -n cocos2d -j cocos2d-mac_hierarchy.txt CCNode CCSprite" % sys.argv[0]
    sys.exit(-1)
...
if __name__ == "__main__":
    ...
    argv = sys.argv[1:]
    try:                                
        opts, args = getopt.getopt(argv, "b:j:n:", ["bridgesupport=","hierarchy=","namespace="])
    ...
    instance = SpiderMonkey(bridgesupport_file, hierarchy_file, namespace, args )
    instance.parse()
