...
class SpiderMonkey(object):
    def __init__(self, bridgesupport_file, hierarchy_file, namespace, prefix, classes_to_bind=[] ):
...
'''
    ...
    def generate_class_binding( self, class_name ):
        ...
        self.mm_file.write( import_template % (BINDINGS_PREFIX+class_name, BINDINGS_PREFIX, self.namespace) )
	...
	self.class_registration_file.write( autogenerated_template %( sys.argv[0], datetime.date.today() ) )
...
if __name__ == "__main__":
    ...
    argv = sys.argv[1:]
    try:                                
        opts, args = getopt.getopt(argv, "b:j:n:p:", ["bridgesupport=","hierarchy=","namespace=","prefix="])
    ...
    instance = SpiderMonkey(bridgesupport_file, hierarchy_file, namespace, prefix, args )
    instance.parse()
