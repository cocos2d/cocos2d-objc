...
* Generated by "generate_spidermonkey_bindings.py -c CocosBuilderReader_spidermonkey.ini" on 2012-07-17
*/
...
// Destructor
void JSPROXY_CCBReader_finalize(JSContext *cx, JSObject *obj)
{
...
//	JSPROXY_CCBReader_class->flags = JSCLASS_HAS_PRIVATE;
	...
	static JSFunctionSpec st_funcs[] = {
		...
		JS_FN("nodeGraphFromFile", JSPROXY_CCBReader_nodeGraphFromFile_owner_parentSize__static, 3, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("sceneWithNodeGraphFromFile", JSPROXY_CCBReader_sceneWithNodeGraphFromFile_owner_parentSize__static, 3, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
