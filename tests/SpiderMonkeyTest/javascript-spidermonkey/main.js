...
var MainTest = BaseLayer.extend({
    ...
    onEnter:function () {
        ...
        var item6 = cc.MenuItemFont.create("Particle Tests", this, function() { require("javascript-spidermonkey/test-particles.js"); } );
        var item7 = cc.MenuItemFont.create("Sprite Tests", this, function() { require("javascript-spidermonkey/test-sprite.js"); } );
        var item8 = cc.MenuItemFont.create("Tilemap Tests", this, function() { require("javascript-spidermonkey/test-tilemap.js"); } );
        var item9 = cc.MenuItemFont.create("CocosDenshion Tests", this, function() { require("javascript-spidermonkey/test-cocosdenshion.js"); } );
        var item10 = cc.MenuItemFont.create("cocos2d presentation", this, function() { require("javascript-spidermonkey/test-cocos2djs.js"); } );


        this._menu = cc.Menu.create( item1, item2, item3, item4, item5, item6, item7, item8, item9, item10 );
        this._menu.alignItemsVertically();
