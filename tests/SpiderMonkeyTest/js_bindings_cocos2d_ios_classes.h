...
void JSPROXY_CCES2Renderer_createClass(JSContext *cx, JSObject* globalObj, const char* name );

extern JSObject *JSPROXY_CCES2Renderer_object;
extern JSClass *JSPROXY_CCES2Renderer_class;
...
/* Proxy class */
@interface JSPROXY_CCES2Renderer : JSPROXY_NSObject
{
}
