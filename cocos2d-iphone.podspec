Pod::Spec.new do |spec|
  ...
  spec.xcconfig = {
    'HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/Headers/cocos2d-iphone/kazmath/include" "${PODS_ROOT}/Headers/cocos2d-iphone/Chipmunk/objectivec/include/" "${PODS_ROOT}/Headers/cocos2d-iphone/Chipmunk/include/"'
  }
